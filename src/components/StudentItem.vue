    ...
    <div v-if="isRenderByVisible()">
      ...
      <div class="standing_item_row_container">
        ...
        <div class="p-pipe">
          <t-tooltip
            placement="bottom"
            :content="`${props.standingData.part1.score} / 100`"
          >
            <img
        ...
        <div class="p-pipe">
          <t-tooltip
            placement="bottom"
            :content="`${props.standingData.part2.score} / 100`"
          >
            <img
        ...
        <div class="p-pipe">
          <t-tooltip
            placement="bottom"
            :content="`${props.standingData.part3.score} / 90`"
          >
            <img
